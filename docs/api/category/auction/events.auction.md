...
Обработка события производится в зарегистрированном обработчике. Коды результата см. в `ENUM_AuctionBidResultMsgResult_...`.
...
Обработка события производится в зарегистрированном обработчике. Коды результата см. в `ENUM_AuctionCreateResultMsg_...`.
...
Обработка события производится в зарегистрированном обработчике. Коды результата см. в `ENUM_AuctionDiscardResultMsgResult_...`.
...
Обработка события производится в зарегистрированном обработчике. Коды результата см. в `ENUM_AuctionGetParamsResultMsgStatus_...`.
...
Обработка события производится в зарегистрированном обработчике. Коды результата см. в `ENUM_AuctionSearchResultMsgResult_...`.
