---
description: Возвращает список идентификаторов подменяющих заклинаний для указанного умения.
---
...
Возвращает `table` - Таблица идентификаторов ресурсов заклинаний. Индексация начинается с 1.
