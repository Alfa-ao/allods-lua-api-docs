---
description: Возвращает список идентификаторов заклинаний из указанной группы для заданного класса персонажа.
---
...
Возвращает таблицу, содержащую идентификаторы заклинаний (`SpellId`). Таблица индексируется с `0`.
