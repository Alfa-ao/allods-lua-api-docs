---
description: Возвращает информацию о бонусе к характеристикам аватара при использовании заклинаний из указанной группы.
---
...
Возвращает таблицу с бонусами к характеристикам. Содержит пары ключ-значение:
