---
description: Возвращает стоимость улучшения мета-предмета в меди.
---
...
- **`sourceId`** (`ObjectId`) - Идентификатор предмета, который подлежит улучшению.

- **`enhancerId`** (`ObjectId`) - Идентификатор предмета-улучшителя, применяемого для модификации целевого предмета.

- **`agentId`** (`ObjectId`) - Идентификатор агента улучшения, осуществляющего операцию модификации.
