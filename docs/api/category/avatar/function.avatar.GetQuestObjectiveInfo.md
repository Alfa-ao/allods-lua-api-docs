---
description: Извлекает информацию об одной цели задания игрока.
---
...
- **`objectiveId`** (`ObjectId`) - Уникальный идентификатор цели задания, информацию о которой необходимо получить.
