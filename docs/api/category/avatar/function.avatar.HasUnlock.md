---
description: Определяет наличие указанного анлока у аватара.
---
...
- **`unlockId`** `(UnlockId)` - Идентификатор возможности (анлока), наличие которой необходимо проверить.

## Возвращаемые значения

Возвращает `boolean` - `true`, если у аватара имеется указанный анлок, и `false` в противном случае.
