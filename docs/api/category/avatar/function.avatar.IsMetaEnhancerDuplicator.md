---
description: Определяет, является ли предмет инструментом для копирования метаитема-улучшителя.
---
...
- **`itemId`** (`ObjectId`) - Уникальный идентификатор предмета, который необходимо проверить.
