---
description: Возвращает таблицу с логическими значениями для каждого предмета, указывающими, надет ли этот или аналогичный гардеробный предмет на персонажа.
---
