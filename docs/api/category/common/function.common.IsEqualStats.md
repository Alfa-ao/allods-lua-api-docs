---
description: Проверяет соответствие двух характеристик друг другу на основе их идентификаторов.
---
...
Возвращает `boolean` - если обе характеристики влияют на один и тот же параметр `true`, иначе `false`, если характеристики влияют на разные параметры.
