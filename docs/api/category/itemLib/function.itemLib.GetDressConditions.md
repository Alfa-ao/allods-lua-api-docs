---
description: Возвращает подробную информацию о возможности экипировки предмета, включая первое выполненное или невыполненное условие и полный список всех невыполненных условий.
---
