---
description: Возвращает аватара в инстанс-ивент, если он его покинул, но остался в рейде или группе.
---
...
- [matchMaking.CanReturnToBattle](/api/category/matchMaking/function.matchMaking.CanReturnToBattle.md)