...
Функция возвращает полную таблицу [WidgetPlacement](/articles/WidgetPlacementLua.md), описывающую положение виджета. Неявные параметры могут иметь произвольное значение (поведение не определено).
