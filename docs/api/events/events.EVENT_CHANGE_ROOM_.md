...
В режиме парикмахерской камера закончила движение после вызова `changeRoom.SetCameraPath(...)`.
...
- [changeRoom.SetCameraPath](/api/category/changeRoom/function.changeRoom.SetCameraPath.md)
