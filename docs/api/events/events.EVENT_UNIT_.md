...
Событие присылается при изменении процентного значения маны юнита и числового значения для аватара.

::: warning Замечание
Событие приходит только если аватар находится в группе или рейде с ГГ.
:::
...
Событие присылается при изменении маны юнита.

::: warning Замечание
Для срабатывания данного события требуется указание идентификатора объекта в качестве параметра функции `common.RegisterEventHandler`.
:::
