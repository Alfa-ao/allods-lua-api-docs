...
Идентификатор эффекта наложенного на игрока в бою. Используется для отображения логе боя усиливающих и ослабляющих эффектов, которые были на игроке в момент нанесения урона. Один из типов группы `ResourceId`.
