---
description: Идентификатор цели. Один из типов группы `ResourceId`. (В настоящее время идентификатор пассивного умения - идентификатор его ресурса в базе).
---

# GoalId

Идентификатор цели. Один из типов группы `ResourceId`. (В настоящее время идентификатор пассивного умения - идентификатор его ресурса в базе).
