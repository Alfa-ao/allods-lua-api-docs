---
description: Идентификатор ресурса категории сражения (инстанс-ивента). Один из типов группы `ResourceId`.
---
...
allowDummyPass: Boolean - доступность Бескорыстной Помощи для ивентов из данной категории, true - доступна
```