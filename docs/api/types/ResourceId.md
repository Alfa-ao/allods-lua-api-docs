---
outline: deep
description: Группа типов, являющихся идентификаторами ресурсов из базы. Один из пользовательских типов данных. Реализация каждого из типов данной группы - `userdata` с метатаблицей, соответствующей определенной категории ресурсов базы или `nil` (в случае отсутствия ресурса). Название типа и метатаблицы совпадают.
---
