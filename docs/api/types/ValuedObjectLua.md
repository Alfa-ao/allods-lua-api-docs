---
description: ValuedObject - это обёртка игрового объекта для подстановки в ValuedText. Представляет собой специальный вариант userdata и имеет несколько методов.
---
