---
description: Идентификатор корпуса корабля. Один из типов группы `ResourceId`. (В настоящее время идентификатор корпуса корабля - идентификатор его ресурса в базе).
---
